    ...
    <div className="font-display pb-4">
      ...
      {showAddMenu && (
        <div className="fixed inset-0 z-[200] flex items-end" onClick={() => setShowAddMenu(false)}>
          ...
          <div className="relative bg-white w-full rounded-t-3xl px-5 pt-4 pb-20 z-10" onClick={e => e.stopPropagation()} style={{ paddingBottom: "calc(60px + env(safe-area-inset-bottom, 16px))" }}>
