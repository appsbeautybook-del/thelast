...
const KNOWN_COLUMNS = {
  ...
  Service: ['id','name','title','description','price','category','subcategory','style','duration_min','images','pro_email','status','addons','tags','rating','reviews_count','max_persons','promo_price','promo_ends_at','audience','created_at','updated_at','created_by_id'],
